...
function AboutUs() {
  return (
    <div className="about-container">
      ...
      <h1>Our Mission</h1>
      <p>
        At Go See! Travel & Tourism, our mission is to ignite the spirit of
        adventure and exploration in every traveler's heart while fostering a
        deep appreciation for the world's diverse cultures and environments. We
        are driven by the belief that travel has the power to transform lives,
